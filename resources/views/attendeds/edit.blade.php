    ...
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-slate-500">
                Perbarui data pimpinan yang menghadiri kegiatan
            </p>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
                ...
                <form action="{{ route('attendeds.update', $attended->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $attended->name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="rank" value="{{ old('rank', $attended->rank) }}"
                            class="w-full rounded-lg border-slate-300 focus:border-slate-800 focus:ring-slate-800"
                            required>
