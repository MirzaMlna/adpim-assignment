                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="role"
                                ...
                                <option value="PIMPINAN ADPIM">PIMPINAN ADPIM</option>
                            </select>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="note" rows="3"
                                class="w-full rounded-lg border-slate-300 focus:border-slate-800 focus:ring-slate-800">{{ old('note') }}</textarea>
                        </div>
